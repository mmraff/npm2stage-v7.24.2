...
/*
  Assume that constants.targets.ADDED_FILES does not have enough deep new files
  to thoroughly test checkForDeepNewFiles().
  This will also be significant down in test named
  'target has signs of npm-two-stage installation'
*/
TGTS.ADDED_FILES.push('unreal/fake', 'unreal/decoy')
