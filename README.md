# @offliner/npm2stage-v7.24.2
CLI to manage [**npm-two-stage**](https://github.com/mmraff/npm-two-stage/tree/npm7.24.2 "Learn why you might want this!") installation for npm 7.24.2

## Installation
```
$ npm install -g @offliner/npm2stage-v7.24.2
```
...
In these examples, the OS is Windows, the tool is used in a git bash console, and the target location is the typical global installation location. However, the tool (and [**npm-two-stage**](https://github.com/mmraff/npm-two-stage/tree/npm7.24.2 "Learn why you might want this!")) are platform-agnostic, and the target npm installation can be any accessible location, including on a removeable drive.
```
$ npm2stage status
